    ...
    <>
      <motion.div className="z-[-10] bg-gradient-to-tr from-purple-600 to-purple-100 w-screen h-screen center" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} id="projects">
        <div className="flex gap-[50px]">
          <Link to='/counter'>
            <div className="w-[400px] hover:shadow-2xl hover:shadow-white relative h-[600px] bg-slate-100 cursor-pointer rounded-2xl">
              <div className="absolute p-3 h-[50%] leading-10"><img src="image/counter.png" alt="" className='rounded-2xl' />
                <div className="h-[90%] mt-2 text-xl font-medium px-4">
          ...
          <Link to='/calculator'>
            <div className="w-[400px] hover:shadow-2xl hover:shadow-white h-[600px] bg-slate-100 rounded-2xl relative cursor-pointer">
